...
function checkItem(elem) {
 ...
 parentLI.style.textDecoration = "solid gray line-through   2px";
...
function saveList() {
  document.cookie = "list=" + itemList.innerHTML;
}

function loadList() {
  let oldList = document.cookie.substring(5);
  if (oldList != "") itemList.innerHTML = oldList;
}
